...
typedef unsigned long ulong;			// Inode number is just a ulong
...
typedef struct inode {
	...
	uint blocks[NBLOCKS];			/* Directly addressable blocks (8 of them) */
...
typedef struct superblock {
	...
	inode ino;				// Root directory entry
